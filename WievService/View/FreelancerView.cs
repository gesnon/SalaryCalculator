...
namespace ViewService.View
{
    public class FreelancerView
    {
        ...
        public void GetPersonRecords(Person person)
        {
            ...
            List<Record> records = freelancerService.GetPersonRecords(person, firstDate, secondDate);
        ...
        public void AddRecord(Person creator)
        {
            ...
            freelancerService.CreateRecord(new Record() { Date = date, Time = time, Owner = creator, Creator = creator, Description = description });
        }
    }
}
